...
<html>
    ...
    <body>
        ...
        <div id="show-requestForm" class="content scaffold-show" role="main">
            ...
            <f:display bean="requestForm" />
            <g:form resource="${this.requestForm}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.requestForm}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
